...
$profiles = [
    ...
    'showcase-directory-2' => [
        ...
        'title_ar' => 'استراتيجي علامة تجارية',
        'company_en' => 'Studio North',
        'company_ar' => 'استوديو نورث',
        'accent' => '#0789a3',
    ],
    ...
    'showcase-directory-4' => [
        'name_en' => 'Yusuf Hamad',
        'name_ar' => 'يوسف حمد',
        'title_en' => 'Client Partner',
        'title_ar' => 'شريك العملاء',
        'company_en' => 'Studio North',
        'company_ar' => 'استوديو نورث',
        'accent' => '#0789a3',
    ],
    'showcase-directory-5' => [
        'name_en' => 'Salma Rashid',
        'name_ar' => 'سلمى راشد',
        'title_en' => 'Product Manager',
        'title_ar' => 'مديرة منتجات',
        'company_en' => 'Studio North',
        'company_ar' => 'استوديو نورث',
        'accent' => '#0789a3',
    ],
