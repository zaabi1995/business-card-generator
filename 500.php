...
<?php require_once INCLUDES_DIR . '/ui-header.php'; ?>
    <div class="flex flex-col justify-center items-center px-6 mx-auto min-h-screen xl:px-0">
        <div class="block md:max-w-lg mb-8">
            <img src="<?php echo assetUrl('images/illustrations/500.svg'); ?>" alt="Server error illustration" class="w-full h-auto">
        </div>
        <div class="text-center xl:max-w-4xl">
            ...
            <p class="mb-6 text-base font-normal text-gray-500 md:text-lg">
                We're experiencing technical difficulties. Please try again in a few moments. If the problem persists, contact support.
            </p>
