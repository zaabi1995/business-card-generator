...
<main class="bg-gray-50 pt-24 pb-16">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section class="mb-16">
            <article class="relative bg-white rounded-3xl p-8 lg:p-10 ring-1 ring-gray-200/70 shadow-xl">
                <span class="absolute -top-3 <?= $isAr ? 'right-8' : 'left-8' ?> px-4 py-1 bg-green-600 text-white text-xs font-bold rounded-full uppercase tracking-wider"><?= htmlspecialchars(t('pricing.platform_badge')) ?></span>
