...
$format    = $_GET['format'] ?? '';
$allowed   = [
    'svg', 'png_512', 'png_1024', 'png_2048', 'webp', 'zip',
    // Monochrome variants (generated by LogoLibrary::generateMonochromeVariants)
    'svg_dark', 'png_dark', 'webp_dark',
    'svg_white', 'png_white', 'webp_white',
];
...
$col = match ($format) {
    ...
    'webp'       => 'logo_webp_path',
    'svg_dark'   => 'logo_svg_dark_path',
    'png_dark'   => 'logo_png_dark_path',
    'webp_dark'  => 'logo_webp_dark_path',
    'svg_white'  => 'logo_svg_white_path',
    'png_white'  => 'logo_png_white_path',
    'webp_white' => 'logo_webp_white_path',
    'zip'        => null,
};
...
if ($format === 'zip') {
    ...
    $mime = match (true) {
        $format === 'svg'  || str_starts_with($format, 'svg_')  => 'image/svg+xml',
        $format === 'webp' || str_starts_with($format, 'webp_') => 'image/webp',
        default                                                 => 'image/png',
    };
