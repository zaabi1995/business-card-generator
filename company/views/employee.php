        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <form method="post" class="p-6 space-y-6">
                ...
                <div class="grid md:grid-cols-2 gap-3">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Label <span class="text-xs text-gray-400">— optional</span></label>
                ...
                <input type="hidden" name="section_order" value="<?php echo sanitize($sectionMaster['section_order'] ?? 'bio,services,gallery,testimonials,lead_form,offers,location'); ?>">
