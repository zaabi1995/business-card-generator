...
/** @var string $brand */
$b = htmlspecialchars($brand ?? 'كارديفاي', ENT_QUOTES);
$subject = "رمز التحقق الخاص بك في {$b}";
$body = <<<HTML
<div dir="rtl" style="font-family:'IBM Plex Sans Arabic',system-ui,sans-serif;max-width:560px;margin:0 auto;padding:24px;color:#1f2937;">
  ...
  <p>استخدم الرمز أدناه لإكمال تسجيل الدخول إلى {$b}.</p>
  ...
  <p style="color:#6b7280;font-size:14px;">فريق {$b}</p>
</div>
HTML;
