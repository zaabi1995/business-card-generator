...
<div dir="rtl" style="font-family:'IBM Plex Sans Arabic',system-ui,sans-serif;max-width:600px;margin:0 auto;padding:24px;color:#1f2937;">
  <h1 style="color:#009bc1;margin-bottom:8px;">حسابك أصبح مفعّلاً يا {$name}</h1>
  ...
  <p style="margin:20px 0;">
    ...
    &nbsp;
    <a href="{$dashboardUrl}" style="background:#fff;color:#009bc1;border:1px solid #009bc1;padding:12px 24px;border-radius:8px;text-decoration:none;display:inline-block;font-weight:600;">الانتقال إلى لوحة التحكم</a>
  </p>
