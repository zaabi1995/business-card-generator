...
/** @var string $brand */
$b = htmlspecialchars($brand ?? 'Cardify', ENT_QUOTES);
$subject = "Your {$b} verification code";
$body = <<<HTML
<div style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto;padding:24px;color:#1f2937;">
  ...
  <p>Use the one-time code below to finish signing in to {$b}.</p>
  ...
  <p style="color:#6b7280;font-size:14px;">The {$b} team</p>
</div>
HTML;
