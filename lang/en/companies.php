...
return [
    ...
    'about_sovereign'            => ':name is a state-sector entity of the Sultanate of Oman, classified under :sector in :wilayat governorate.',
    'about_logo_note'            => 'This page displays the logo as indexed in the Omani Logo Library. The mark remains the property of the Sultanate of Oman and its representing body.',
    'about_based_in'             => ':name is based in :wilayat.',
    'about_register_line'        => ':name is listed as a :size enterprise on the MoCIIP public register of the Sultanate of Oman, classified under the :sector sector in :wilayat governorate.',
