...
return [
    ...
    'pro_enabled'          => 'ميزة Pro مفعّلة',
    'pro_required'         => 'ميزة Pro، تتطلّب الترقية',

    // بوّابة الترقية
    'gate_h2'              => 'النطاقات المخصّصة من ميزات Pro',
    'gate_body'            => 'ارتقِ إلى Pro ليتمكّن فريقك من عرض بطاقاته الرقمية من نطاقهم الخاص، مثل <code>ceo.acme.com</code>.',
    'gate_cta'             => 'ترقية الباقة',
