...
<div class="min-h-screen bg-gray-50">
    <!-- Hero Section -->
    <div class="bg-gradient-to-br from-yellow-600 via-amber-700 to-orange-700 text-white py-20 pt-32">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto">
                ...
                <h1 class="text-4xl md:text-5xl font-bold mb-6">Business Cards for Construction & Engineering in Oman</h1>
                ...
                <a href="<?php echo getBasePath(); ?>company/register.php"
                   class="inline-flex items-center gap-2 px-8 py-4 bg-white text-amber-700 font-semibold rounded-xl hover:bg-yellow-50 transition-colors text-lg">
        ...
        <div class="mb-20">
            <div class="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-2xl p-8 lg:p-12">
                <div class="text-center mb-10">
                    <h2 class="text-3xl font-bold text-gray-900">Trusted by Construction Companies Across Oman</h2>
                </div>
                <div class="grid md:grid-cols-4 gap-6 text-center">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm">
                        <div class="text-3xl font-bold text-amber-600 mb-2">Bulk</div>
                        <div class="text-gray-500 text-sm">Team Card Generation</div>
                    </div>
                    <div class="bg-white rounded-xl p-6 shadow-sm">
                        <div class="text-3xl font-bold text-amber-600 mb-2">NFC</div>
