...
<div class="min-h-screen bg-white">
    ...
    <div class="bg-gray-50 py-8 px-4 border-b border-gray-100">
        <div class="max-w-5xl mx-auto flex flex-wrap items-center justify-center gap-8 md:gap-16 text-center">
            <div>
            ...
            <div>
                ...
                <div class="text-sm text-gray-500">Cards Created</div>
            </div>
            <div>
            ...
            <div>
                ...
                <div class="text-sm text-gray-500">To Start</div>
            </div>
        </div>
    </div>
