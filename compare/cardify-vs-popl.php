...
<div class="min-h-screen bg-gray-50">
    ...
    <article class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-lg">
        ...
        <p>
            Cardify publishes everything. The web platform is free, permanently, for unlimited employees, unlimited templates and unlimited cards, with no credit card required. The only money that changes hands is for physical cards, at OMR 5.000 per 100 Standard, OMR 6.000 per 100 Premium, OMR 15.000 per 100 Luxury, and OMR 25.000 for an NFC tap card. That is the entire commercial relationship, on a <a href="<?= $base ?>pricing">public page</a>.
        </p>
