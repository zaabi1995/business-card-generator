        ...
        <div class="not-prose overflow-x-auto my-8">
            <table class="min-w-full text-sm border border-gray-200 rounded-lg overflow-hidden bg-white">
                ...
                <tbody class="text-gray-600">
                    ...
                    <tr><td class="px-4 py-3 border-b border-gray-100 font-medium text-gray-900">NFC cards with published price</td><td class="px-4 py-3 border-b border-gray-100">Yes, OMR 10.000 each</td><td class="px-4 py-3 border-b border-gray-100">Sold, no price on the page checked</td></tr>
