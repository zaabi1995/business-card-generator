# Production Deployment Checklist for Cardify

This checklist ensures your Cardify platform is ready for production deployment.

## Pre-Deployment

### 1. Domain & DNS Setup
- [ ] Configure DNS A record for `cardify.om` pointing to your server IP
- [ ] Verify DNS propagation: `nslookup cardify.om` or `dig cardify.om`
- [ ] Wait for DNS propagation (can take up to 48 hours)

### 2. SSL Certificate
- [ ] Install SSL certificate (Let's Encrypt recommended)
- [ ] Configure automatic renewal
- [ ] Test SSL: `https://cardify.om` should load with valid certificate
...
- [ ] Navigate to `https://cardify.om/install/`
...
- [ ] Set callback URL in Amwal Pay dashboard:
  `https://cardify.om/amwalpay/callback.php`
...
### 1. File Security
- [ ] `config.php` is not accessible via web (test: `https://cardify.om/config.php` should return 403)
...
- [ ] Homepage loads: `https://cardify.om/`
- [ ] Company registration works: `https://cardify.om/company/register.php`
- [ ] Company login works: `https://cardify.om/company/login.php`
- [ ] Admin panel accessible: `https://cardify.om/admin/`
...
- [ ] Billing page loads: `https://cardify.om/admin/billing.php`
