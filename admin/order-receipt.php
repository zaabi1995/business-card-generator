...
<div class="no-print bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between sticky top-0 z-10">
    ...
    <div class="flex items-center gap-2">
        <a href="<?= getBasePath() ?>admin/order-checkout.php?order=<?= $orderId ?>" class="px-4 py-2 text-sm bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg font-medium transition-colors">
            <i class="fa-solid fa-arrow-left mr-1"></i> Back to Payment
        </a>
...
<div class="max-w-2xl mx-auto my-8 px-4">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="bg-blue-600 px-8 py-6 text-white">
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="text-right">
                    <p class="text-blue-200 text-xs uppercase tracking-wide">Payment Receipt</p>
            ...
            <div class="flex items-end justify-between">
                <div>
                    ...
                    <p class="font-medium"><?= date('F j, Y', strtotime($receiptDate)) ?></p>
                </div>
                <div class="text-right">
                    <p class="text-blue-200 text-xs mb-1">Status</p>
                    <?php if ($paidDeposit): ?>
                    <span class="bg-amber-400 text-amber-900 text-xs font-bold px-2.5 py-1 rounded-full">Deposit Paid</span>
                    <?php else: ?>
                    <span class="bg-green-400 text-green-900 text-xs font-bold px-2.5 py-1 rounded-full">Paid in Full</span>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-6 px-8 py-6 border-b border-gray-100">
            <div>
                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-2">Billed To</p>
            ...
            <div>
                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-2">Print Shop</p>
        ...
        <div class="px-8 py-6 border-b border-gray-100">
            <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-4">Order Details</p>
                ...
                <tbody class="divide-y divide-gray-50">
                    <tr class="py-2">
                        <td class="py-2">
                            ...
                            <p class="text-gray-500 text-xs"><?= ucfirst($order['paper_type'] ?? 'Standard') ?> &bull; <?= ucfirst(str_replace('_', ' ', $order['finish'] ?? 'matte')) ?><?= !empty($order['express_delivery']) ? ' &bull; Express' : '' ?></p>
                        </td>
                    ...
                    <tr>
                        <td class="py-2 text-gray-600">Setup Fee</td>
                    ...
                    <tr>
                        <td class="py-2 text-gray-600">Express Delivery Fee</td>
                        <td class="py-2 text-right text-gray-500">1</td>
        ...
        <div class="px-8 py-6 border-b border-gray-100">
            <div class="space-y-2">
                ...
                <?php if ($paidDeposit): ?>
                <div class="flex justify-between text-sm text-gray-600">
                    <span>Deposit Paid (<?= number_format($order['deposit_percent'], 0) ?>%)</span>
                ...
                <div class="flex justify-between font-bold text-base border-t border-gray-200 pt-2">
                    <span class="text-amber-700">Balance Due</span>
        ...
        <div class="px-8 py-5 text-center">
            <p class="text-sm text-gray-500">Thank you for your order. For questions, contact your print shop.</p>
