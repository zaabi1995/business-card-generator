    ...
    return {
        ...
        async addFieldsToCard(editor, fields) {
            ...
            const fieldValues = {
                ...
                'position_en_2': this.employee.position_en_2 || '',
                'position_ar_2': this.employee.position_ar_2 || '',
                'position_en_3': this.employee.position_en_3 || '',
                'position_ar_3': this.employee.position_ar_3 || '',
