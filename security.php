...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-white pt-28 pb-12">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl font-bold text-gray-900 mb-3">Security</h1>
            <p class="text-gray-500 text-lg max-w-2xl mx-auto">How we protect your data and keep your information safe</p>
        </div>
    </div>
