...
<div class="min-h-screen bg-gray-50">
    ...
    <article class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-lg">
        ...
        <p>
            You can start free with up to 5 team cards. Paid plans are priced in OMR and include optional printed NFC cards fulfilled by our Muscat partner print shop — delivered within 3 working days to any address in Oman, including Duqm and Salalah. Every paid plan includes bilingual Arabic/English profiles, custom domain (cards.yourcompany.om), and a branded QR that matches your corporate colours.
        </p>
        ...
        <div class="not-prose bg-blue-50 border-l-4 border-blue-500 rounded-lg p-6 my-8">
            ...
            <p class="text-blue-800 mb-4">Create digital business cards for your team — free to start with <?php echo $brandName; ?>. Roll out to 5 reps today, scale to your whole sales org when you're ready.</p>
