...
$articleJsonLd = Seo::articleNode(
    __FILE__,
    'Business Cards for Duqm Free Zone Companies',
    $pageDescription,
    $canonicalUrl,
    $ogImage ?? null,
    'en-OM'
