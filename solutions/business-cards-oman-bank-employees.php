...
$articleJsonLd = Seo::articleNode(
    __FILE__,
    'Business Cards for Oman Bank & Finance Employees',
    $pageDescription,
    $canonicalUrl,
    $ogImage ?? null,
    'en-OM'
...
<div class="min-h-screen bg-gray-50">
    ...
    <article class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-lg">
        ...
        <p>
            An Oman bank with 2,500 employees can't have individual staff creating business cards with random logos and inconsistent contact formats, that's a brand and compliance nightmare, and it opens a social-engineering attack vector. Cardify is built for this: your bank's IT or Corporate Communications team controls the master template (exact logo, exact typography, exact colour of your blue), and individual employees can edit only their role-specific fields (name, direct line, email, photo). Any attempt to edit a locked field requires an admin approval. When an employee leaves, their card is revoked instantly, the URL returns to a centrally-controlled "This employee is no longer with [Bank Name]. Your current relationship manager is [X]" landing page.
        </p>
        <p>
        ...
        <p>
            Banking customers in Oman are targeted by a constant barrage of phishing SMS pretending to be from their bank. A business card that resolves to a generic URL like cardify.om/j-smith-bank is exactly the kind of thing a phisher could clone. Cardify's banking-grade setup solves this: each bank gets a branded subdomain like cards.bankmuscat.com or bank.sohar-intl.om, so every RM's card URL carries the bank's own domain. Customers see "Dhofar" or "Sohar" in the URL and trust it. Combined with the bank's own SSL certificate and a green padlock, the card becomes a trust asset rather than a risk.
        </p>
        <p>
