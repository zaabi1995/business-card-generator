...
$pageDescription = 'Startups at KOM, Ejadah, Oman Technology Fund-backed companies. Founder cards with pitch deck link, waitlist capture, investor CV download. Free tier.';
...
<div class="min-h-screen bg-gray-50">
    ...
    <article class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-lg">
        ...
        <p><strong>Create digital business cards for your team — free to start with <?php echo $brandName; ?>.</strong> Free tier is more than enough for a pre-seed / seed founder. <a href="<?php echo getBasePath(); ?>company/register.php" class="text-blue-600 font-semibold">Start your founder card &rarr;</a></p>
