...
$articleJsonLd = Seo::articleNode(
    __FILE__,
    'Business Cards for Muscat Doctors and Clinics',
    $pageDescription,
    $canonicalUrl,
    $ogImage ?? null,
    'en-OM'
