...
$articleJsonLd = [
    '@context' => 'https://schema.org',
    '@type' => 'Article',
    'headline' => 'Business Cards for Omani Law Firms',
...
<div class="min-h-screen bg-gray-50">
    ...
    <article class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-lg">
        ...
        <p><strong>Create digital business cards for your team — free to start with <?php echo $brandName; ?>.</strong> Upgrade to uncoated letterpress cards for the senior partners. <a href="<?php echo getBasePath(); ?>company/register.php" class="text-blue-600 font-semibold">Set up your firm &rarr;</a></p>
