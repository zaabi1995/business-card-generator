...
<section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    ...
    <p class="text-gray-600 mb-6">Everything people ask about this tool — privacy, compatibility, what works, what doesn't.</p>
    <div class="space-y-3">
        <?php foreach ($faq as $i => $q): ?>
            <details class="group bg-white border border-gray-200 rounded-xl hover:border-blue-300 transition overflow-hidden"<?= $i === 0 ? ' open' : '' ?>>
                ...
                <div class="px-5 pb-4 text-gray-600 leading-relaxed"><?= $_faq_esc($q['a']) ?></div>
            </details>
        <?php endforeach; ?>
    </div>
</section>
